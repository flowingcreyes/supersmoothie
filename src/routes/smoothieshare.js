...
router.post(
  "/smoothieshare/create",
  helper.ensureAuthenticated,
  validation.validateSubjects,
  smoothieshareController.create
);
router.get("/smoothieshare/signup", smoothieshareController.signUp);
router.post(
  "/users",
  validation.validateUsers,
  smoothieshareController.createAccount
);
...
router.post(
  "/smoothieshare/:id/update",
  validation.validateSubjects,
  smoothieshareController.update
);
router.post("/smoothieshare/:id/destroy", smoothieshareController.destroy);
router.post(
  "/users/signin",
  validation.validateUsers,
  smoothieshareController.signIn
);
